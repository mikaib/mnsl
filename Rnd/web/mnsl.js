// Generated by Haxe 5.0.0-alpha.1+cefabb1
...
mnsl_MNSLContext.__name__ = "mnsl.MNSLContext";
mnsl_MNSLContext.prototype = {
	...
	,errorToString: function(error) {
		...
		case 27:
			...
			var node = error.node;
			var info = error.info;
			return "Variable " + name + " is not allowed outside of a function at " + Std.string(node) + " at " + Std.string(info);
		case 28:
			var func = error.func;
		...
		case 31:
			var name = error.name;
			var info = error.info;
			return "Function " + name + " cannot be defined inside another function at " + Std.string(info);
		case 32:
...
mnsl_MNSLContextOptions.__name__ = "mnsl.MNSLContextOptions";
mnsl_MNSLContextOptions.prototype = {
	__class__: mnsl_MNSLContextOptions
};
var mnsl_MNSLError = $hxEnums["mnsl.MNSLError"] = { __ename__:"mnsl.MNSLError",__constructs__:null
	,TokenizerInvalidChar: ($_=function(char,pos) { return {_hx_index:0,char:char,pos:pos,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.char,this.pos];}}; },$_._hx_name="TokenizerInvalidChar",$_)
	,TokenizerPreprocessorError: ($_=function(msg,pos) { return {_hx_index:1,msg:msg,pos:pos,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.msg,this.pos];}}; },$_._hx_name="TokenizerPreprocessorError",$_)
	,TokenizerUnterminatedString: ($_=function(pos) { return {_hx_index:2,pos:pos,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.pos];}}; },$_._hx_name="TokenizerUnterminatedString",$_)
	,ParserInvalidToken: ($_=function(token) { return {_hx_index:3,token:token,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.token];}}; },$_._hx_name="ParserInvalidToken",$_)
	,ParserInvalidKeyword: ($_=function(value,pos) { return {_hx_index:4,value:value,pos:pos,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.value,this.pos];}}; },$_._hx_name="ParserInvalidKeyword",$_)
	,ParserUnexpectedToken: ($_=function(token,pos) { return {_hx_index:5,token:token,pos:pos,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.token,this.pos];}}; },$_._hx_name="ParserUnexpectedToken",$_)
	,ParserUnexpectedExpression: ($_=function(node,pos) { return {_hx_index:6,node:node,pos:pos,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.node,this.pos];}}; },$_._hx_name="ParserUnexpectedExpression",$_)
	,ParserConditionalWithoutIf: ($_=function(pos) { return {_hx_index:7,pos:pos,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.pos];}}; },$_._hx_name="ParserConditionalWithoutIf",$_)
	,AnalyserNoImplementation: ($_=function(fn,pos) { return {_hx_index:8,fn:fn,pos:pos,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.fn,this.pos];}}; },$_._hx_name="AnalyserNoImplementation",$_)
	,AnalyserDuplicateVariable: ($_=function(name,pos) { return {_hx_index:9,name:name,pos:pos,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.name,this.pos];}}; },$_._hx_name="AnalyserDuplicateVariable",$_)
	,AnalyserUndeclaredVariable: ($_=function(name,pos) { return {_hx_index:10,name:name,pos:pos,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.name,this.pos];}}; },$_._hx_name="AnalyserUndeclaredVariable",$_)
	,AnalyserReturnOutsideFunction: ($_=function(pos) { return {_hx_index:11,pos:pos,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.pos];}}; },$_._hx_name="AnalyserReturnOutsideFunction",$_)
	,AnalyserMissingReturn: ($_=function(func,node) { return {_hx_index:12,func:func,node:node,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.func,this.node];}}; },$_._hx_name="AnalyserMissingReturn",$_)
	,AnalyserMismatchingType: ($_=function(constraint) { return {_hx_index:13,constraint:constraint,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.constraint];}}; },$_._hx_name="AnalyserMismatchingType",$_)
	,AnalyserUnknownType: ($_=function(type,node) { return {_hx_index:14,type:type,node:node,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.type,this.node];}}; },$_._hx_name="AnalyserUnknownType",$_)
	,AnalyserUnresolvedConstraint: ($_=function(constraint) { return {_hx_index:15,constraint:constraint,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.constraint];}}; },$_._hx_name="AnalyserUnresolvedConstraint",$_)
	,AnalyserInvalidAssignment: ($_=function(on) { return {_hx_index:16,on:on,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.on];}}; },$_._hx_name="AnalyserInvalidAssignment",$_)
	,AnalyserInvalidAccess: ($_=function(on) { return {_hx_index:17,on:on,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.on];}}; },$_._hx_name="AnalyserInvalidAccess",$_)
	,AnalyserInvalidVectorComponent: ($_=function(comp,info) { return {_hx_index:18,comp:comp,info:info,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.comp,this.info];}}; },$_._hx_name="AnalyserInvalidVectorComponent",$_)
	,AnalyserRecursiveFunction: ($_=function(functionName,recursionChain,info) { return {_hx_index:19,functionName:functionName,recursionChain:recursionChain,info:info,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.functionName,this.recursionChain,this.info];}}; },$_._hx_name="AnalyserRecursiveFunction",$_)
	,AnalyserUnknownVectorComponent: ($_=function(node,info) { return {_hx_index:20,node:node,info:info,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.node,this.info];}}; },$_._hx_name="AnalyserUnknownVectorComponent",$_)
	,AnalyserInvalidBinop: ($_=function(tLeft,tRight,op,constraint) { return {_hx_index:21,tLeft:tLeft,tRight:tRight,op:op,constraint:constraint,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.tLeft,this.tRight,this.op,this.constraint];}}; },$_._hx_name="AnalyserInvalidBinop",$_)
	,AnalyserInvalidUnaryOp: ($_=function(op,info) { return {_hx_index:22,op:op,info:info,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.op,this.info];}}; },$_._hx_name="AnalyserInvalidUnaryOp",$_)
	,AnalyserLoopKeywordOutsideLoop: ($_=function(node,info) { return {_hx_index:23,node:node,info:info,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.node,this.info];}}; },$_._hx_name="AnalyserLoopKeywordOutsideLoop",$_)
	,AnalyserMismatchingEitherType: ($_=function(limits,node) { return {_hx_index:24,limits:limits,node:node,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.limits,this.node];}}; },$_._hx_name="AnalyserMismatchingEitherType",$_)
	,AnalyserUnknownArraySize: ($_=function(type,node) { return {_hx_index:25,type:type,node:node,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.type,this.node];}}; },$_._hx_name="AnalyserUnknownArraySize",$_)
	,AnalyserReadOnlyAssignment: ($_=function(node) { return {_hx_index:26,node:node,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.node];}}; },$_._hx_name="AnalyserReadOnlyAssignment",$_)
	,AnalyserVariableOutsideFunction: ($_=function(name,node,info) { return {_hx_index:27,name:name,node:node,info:info,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.name,this.node,this.info];}}; },$_._hx_name="AnalyserVariableOutsideFunction",$_)
	,AnalyserInvalidReturnType: ($_=function(func,expected,actual) { return {_hx_index:28,func:func,expected:expected,actual:actual,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.func,this.expected,this.actual];}}; },$_._hx_name="AnalyserInvalidReturnType",$_)
	,AnalyserInvalidArrayAccess: ($_=function(on,index,info) { return {_hx_index:29,on:on,index:index,info:info,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.on,this.index,this.info];}}; },$_._hx_name="AnalyserInvalidArrayAccess",$_)
	,AnalyserInvalidVectorArrayAccess: ($_=function(on,index,info) { return {_hx_index:30,on:on,index:index,info:info,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.on,this.index,this.info];}}; },$_._hx_name="AnalyserInvalidVectorArrayAccess",$_)
	,AnalyserFunctionInsideFunction: ($_=function(name,info) { return {_hx_index:31,name:name,info:info,__enum__:"mnsl.MNSLError",toString:$estr,__params__:function(){ return [this.name,this.info];}}; },$_._hx_name="AnalyserFunctionInsideFunction",$_)
	,AnalyserMissingMainFunction: {_hx_name:"AnalyserMissingMainFunction",_hx_index:32,__enum__:"mnsl.MNSLError",toString:$estr}
};
mnsl_MNSLError.__constructs__ = [mnsl_MNSLError.TokenizerInvalidChar,mnsl_MNSLError.TokenizerPreprocessorError,mnsl_MNSLError.TokenizerUnterminatedString,mnsl_MNSLError.ParserInvalidToken,mnsl_MNSLError.ParserInvalidKeyword,mnsl_MNSLError.ParserUnexpectedToken,mnsl_MNSLError.ParserUnexpectedExpression,mnsl_MNSLError.ParserConditionalWithoutIf,mnsl_MNSLError.AnalyserNoImplementation,mnsl_MNSLError.AnalyserDuplicateVariable,mnsl_MNSLError.AnalyserUndeclaredVariable,mnsl_MNSLError.AnalyserReturnOutsideFunction,mnsl_MNSLError.AnalyserMissingReturn,mnsl_MNSLError.AnalyserMismatchingType,mnsl_MNSLError.AnalyserUnknownType,mnsl_MNSLError.AnalyserUnresolvedConstraint,mnsl_MNSLError.AnalyserInvalidAssignment,mnsl_MNSLError.AnalyserInvalidAccess,mnsl_MNSLError.AnalyserInvalidVectorComponent,mnsl_MNSLError.AnalyserRecursiveFunction,mnsl_MNSLError.AnalyserUnknownVectorComponent,mnsl_MNSLError.AnalyserInvalidBinop,mnsl_MNSLError.AnalyserInvalidUnaryOp,mnsl_MNSLError.AnalyserLoopKeywordOutsideLoop,mnsl_MNSLError.AnalyserMismatchingEitherType,mnsl_MNSLError.AnalyserUnknownArraySize,mnsl_MNSLError.AnalyserReadOnlyAssignment,mnsl_MNSLError.AnalyserVariableOutsideFunction,mnsl_MNSLError.AnalyserInvalidReturnType,mnsl_MNSLError.AnalyserInvalidArrayAccess,mnsl_MNSLError.AnalyserInvalidVectorArrayAccess,mnsl_MNSLError.AnalyserFunctionInsideFunction,mnsl_MNSLError.AnalyserMissingMainFunction];
...
mnsl_MNSLPrinter.__name__ = "mnsl.MNSLPrinter";
...
var mnsl_MNSLWarning = $hxEnums["mnsl.MNSLWarning"] = { __ename__:"mnsl.MNSLWarning",__constructs__:null
	,ImplicitVectorTruncation: ($_=function(node,from,to) { return {_hx_index:0,node:node,from:from,to:to,__enum__:"mnsl.MNSLWarning",toString:$estr,__params__:function(){ return [this.node,this.from,this.to];}}; },$_._hx_name="ImplicitVectorTruncation",$_)
	,ImplicitFloatToInt: ($_=function(node) { return {_hx_index:1,node:node,__enum__:"mnsl.MNSLWarning",toString:$estr,__params__:function(){ return [this.node];}}; },$_._hx_name="ImplicitFloatToInt",$_)
};
...
var mnsl_analysis_MNSLAnalyser = function(context,ast) {
	...
	this._functions = [new mnsl_analysis_MNSLAnalyserFunction("texture",[new mnsl_analysis_MNSLFuncArg("sampler",new mnsl_analysis_MNSLType("Sampler")),new mnsl_analysis_MNSLFuncArg("texCoord",new mnsl_analysis_MNSLType("Vec2"))],new mnsl_analysis_MNSLType("Vec4"),null,null,null,"__mnsl_texture",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("sin",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4"),new mnsl_analysis_MNSLType("Mat2"),new mnsl_analysis_MNSLType("Mat3"),new mnsl_analysis_MNSLType("Mat4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4"),new mnsl_analysis_MNSLType("Mat2"),new mnsl_analysis_MNSLType("Mat3"),new mnsl_analysis_MNSLType("Mat4")]),null,null,null,"__mnsl_sin",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("cos",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4"),new mnsl_analysis_MNSLType("Mat2"),new mnsl_analysis_MNSLType("Mat3"),new mnsl_analysis_MNSLType("Mat4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4"),new mnsl_analysis_MNSLType("Mat2"),new mnsl_analysis_MNSLType("Mat3"),new mnsl_analysis_MNSLType("Mat4")]),null,null,null,"__mnsl_cos",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("tan",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4"),new mnsl_analysis_MNSLType("Mat2"),new mnsl_analysis_MNSLType("Mat3"),new mnsl_analysis_MNSLType("Mat4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4"),new mnsl_analysis_MNSLType("Mat2"),new mnsl_analysis_MNSLType("Mat3"),new mnsl_analysis_MNSLType("Mat4")]),null,null,null,"__mnsl_tan",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("normalize",[new mnsl_analysis_MNSLFuncArg("v",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_normalize",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("dot",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")])),new mnsl_analysis_MNSLFuncArg("y",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],new mnsl_analysis_MNSLType("Float"),null,null,null,"__mnsl_dot",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("cross",[new mnsl_analysis_MNSLFuncArg("x",new mnsl_analysis_MNSLType("Vec3")),new mnsl_analysis_MNSLFuncArg("y",new mnsl_analysis_MNSLType("Vec3"))],new mnsl_analysis_MNSLType("Vec3"),null,null,null,"__mnsl_cross",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("length",[new mnsl_analysis_MNSLFuncArg("v",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],new mnsl_analysis_MNSLType("Float"),null,null,null,"__mnsl_length",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("reflect",[new mnsl_analysis_MNSLFuncArg("I",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")])),new mnsl_analysis_MNSLFuncArg("N",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_reflect",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("refract",[new mnsl_analysis_MNSLFuncArg("I",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")])),new mnsl_analysis_MNSLFuncArg("N",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")])),new mnsl_analysis_MNSLFuncArg("eta",new mnsl_analysis_MNSLType("Float"))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_refract",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("pow",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4"),new mnsl_analysis_MNSLType("Float")])),new mnsl_analysis_MNSLFuncArg("y",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4"),new mnsl_analysis_MNSLType("Float")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4"),new mnsl_analysis_MNSLType("Float")]),null,null,null,"__mnsl_pow",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("exp",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_exp",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("log",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_log",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("sqrt",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_sqrt",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("abs",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_abs",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("clamp",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")])),new mnsl_analysis_MNSLFuncArg("minVal",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")])),new mnsl_analysis_MNSLFuncArg("maxVal",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_clamp",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("mix",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")])),new mnsl_analysis_MNSLFuncArg("y",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")])),new mnsl_analysis_MNSLFuncArg("a",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_mix",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("step",[new mnsl_analysis_MNSLFuncArg("edge",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")])),new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_step",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("smoothstep",[new mnsl_analysis_MNSLFuncArg("edge0",mnsl_analysis_MNSLType.CreateTemplate("E",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")])),new mnsl_analysis_MNSLFuncArg("edge1",mnsl_analysis_MNSLType.CreateTemplate("E",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")])),new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("X",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("X",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_smoothstep",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("max",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")])),new mnsl_analysis_MNSLFuncArg("y",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_max",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("min",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")])),new mnsl_analysis_MNSLFuncArg("y",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_min",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("atan",[new mnsl_analysis_MNSLFuncArg("y",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")])),new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_atan",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("acos",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_acos",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("asin",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_asin",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("mod",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")])),new mnsl_analysis_MNSLFuncArg("y",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_mod",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("fract",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_fract",null,null,null,null,null),new mnsl_analysis_MNSLAnalyserFunction("floor",[new mnsl_analysis_MNSLFuncArg("x",mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]))],mnsl_analysis_MNSLType.CreateTemplate("T",[new mnsl_analysis_MNSLType("Float"),new mnsl_analysis_MNSLType("Vec2"),new mnsl_analysis_MNSLType("Vec3"),new mnsl_analysis_MNSLType("Vec4")]),null,null,null,"__mnsl_floor",null,null,null,null,null)];
...
mnsl_analysis_MNSLAnalyser.__name__ = "mnsl.analysis.MNSLAnalyser";
mnsl_analysis_MNSLAnalyser.isNode = function(value) {
...
mnsl_analysis_MNSLAnalyser.getType = function(node,skipImplicitCast) {
	...
	case 18:
		...
		if(type._type == "Mat" + 2 || type._type == "Mat" + 3 || type._type == "Mat" + 4) {
			...
			return new mnsl_analysis_MNSLType("Vec" + type1,false,[],false);
		}
	...
	case 23:
		var comp = node.components;
		var values = node.nodes;
		return new mnsl_analysis_MNSLType("Vec" + comp,false,[],false);
	case 24:
		var on = node.on;
		var fromComp = node.fromComponents;
		var toComp = node.toComponents;
		return new mnsl_analysis_MNSLType("Vec" + toComp,false,[],false);
	case 25:
		var size = node.size;
		var values = node.nodes;
		return new mnsl_analysis_MNSLType("Mat" + size,false,[],false);
	case 26:
		var value = node.value;
...
mnsl_analysis_MNSLAnalyser.prototype = {
	execAtNode: function(node,ctx) {
		...
		if(this._cpyStck.indexOf(name) != -1) {
			...
			if(name == "FunctionDecl") {
				...
				while(_g < _g1) {
					var i = _g++;
					result[i] = args[i].type;
				}
				var f = ctx.findFunction(params1,result,true);
		...
		while(_g < _g1) {
			var pi = _g++;
			var p = params[pi];
			if(mnsl_analysis_MNSLAnalyser.isNode(p)) {
				params[pi] = this.execAtNode(p,ctx);
				continue;
			}
			if(((p) instanceof Array) && mnsl_analysis_MNSLAnalyser.isNode(p[0])) {
	...
	,execAtNodePre: function(node,ctx) {
		if(node._hx_index == 0) {
			...
			var inlined = node.inlined;
			var info = node.info;
			return this.analyseFunctionDeclPre(node,name,returnType,args,inlined,ctx,info);
		} else {
			return node;
		}
	}
	,analyseFunctionDeclPre: function(node,name,returnType,args,inlined,ctx,info) {
		if(ctx.currentFunction != null) {
			this._context.emitError(mnsl_MNSLError.AnalyserFunctionInsideFunction(name,info));
		}
		...
		while(_g < args.length) {
			...
			++_g;
			if(arg.type == null) {
				arg.type = new mnsl_analysis_MNSLType("Unknown");
			}
			var _this = arg.type;
		...
		var _g5 = node;
		var _g6 = inlined;
		var _g7 = this._ast.indexOf(node) + 1;
		var _g8 = ctx.copy();
		var _g9 = [];
		var _g10 = 0;
		var _g11 = args;
		...
		var f = new mnsl_analysis_MNSLAnalyserFunction(_g,_g2,_g1,_g4,_g8,_g3,null,null,_g5,_g7,_g9.length > 0 || StringTools.startsWith(returnType._type,"Template<") && StringTools.endsWith(returnType._type,">"),_g6);
	...
	,analyseVariableAssignPost: function(node,on,value,ctx,info) {
		...
		case 23:
			...
			while(_g < _g1) {
				var cIdx = _g++;
				blockBody.push(mnsl_parser_MNSLNode.VariableAssign(values[cIdx],mnsl_parser_MNSLNode.StructAccess(mnsl_parser_MNSLNode.SubExpression(value,info),componentOrder[cIdx],new mnsl_analysis_MNSLType("Vec" + comp,false,[],false),info),info));
			}
	...
	,analyseFunctionCallPost: function(node,name,args,returnType,ctx,info) {
		...
		if(f == null) {
			...
			tmp.emitError(mnsl_MNSLError.AnalyserNoImplementation(new mnsl_analysis_MNSLAnalyserFunction(_g,result,returnType,null,null,null,null,null,null,null,null,null),info));
			return node;
		}
		...
		if(StringTools.startsWith(_this._type,"Template<") && StringTools.endsWith(_this._type,">")) {
			...
			if(!Object.prototype.hasOwnProperty.call(templates_h,!key ? null : HxOverrides.substr(_this._type,9,_this._type.length - 10))) {
				var t = new mnsl_analysis_MNSLType("Unknown");
				t.setLimits(f.returnType._limits);
				var _this = f.returnType;
				templates_h[!(StringTools.startsWith(_this._type,"Template<") && StringTools.endsWith(_this._type,">")) ? null : HxOverrides.substr(_this._type,9,_this._type.length - 10)] = t;
				isTemplated = true;
			}
			var _this = f.returnType;
			usedReturnType = templates_h[!(StringTools.startsWith(_this._type,"Template<") && StringTools.endsWith(_this._type,">")) ? null : HxOverrides.substr(_this._type,9,_this._type.length - 10)];
		...
		if(isTemplated && !f.internal) {
			...
			var tReturnType = new mnsl_analysis_MNSLType("Unknown");
			var tArgs = [];
			var _g = 0;
			var _g1 = argTypes.length;
			while(_g < _g1) {
				var idx = _g++;
				var t = new mnsl_analysis_MNSLType("Unknown");
			...
			if(copiedNode._hx_index == 0) {
				var body = copiedNode.body;
				var inlined = copiedNode.inlined;
				modifiedNode = mnsl_parser_MNSLNode.FunctionDecl(tName,tReturnType,tArgs,body,inlined,info);
			} else {
				return copiedNode;
			}
	...
	,analyseArrayAccessPost: function(node,on,index,ctx,info) {
		...
		if(t._type == "Vec" + 2 || t._type == "Vec" + 3 || t._type == "Vec" + 4) {
			...
			if(index._hx_index == 26) {
				...
				var comp = idx != null ? idx.comp : null;
				var comp1 = comp != null ? comp : -1;
				var tmp;
				if(comp1 >= 0) {
					var tmp1;
					switch(t._type) {
				...
				if(tmp) {
					this._context.emitError(mnsl_MNSLError.AnalyserInvalidVectorComponent(comp1,info));
					return node;
				}
	...
	,applyReplacementsToNode: function(node,replacements,exceptions) {
		...
		while(_g < _g1) {
			...
			} else if(mnsl_analysis_MNSLAnalyser.isNode(p)) {
	...
	,checkBranchesOnNode: function(node,inFunction) {
		...
		case 0:
			...
			var inlined = node.inlined;
			var info = node.info;
			var func = new mnsl_analysis_MNSLAnalyserFunction(name,args,returnType,null,null,true,null,null,null,null,null,null);
		...
		default:
			...
			while(_g < _g1) {
				...
				if(((pNode) instanceof Array) && mnsl_analysis_MNSLAnalyser.isNode(pNode[0])) {
					this.checkBranchesOnBody(pNode,inFunction);
				} else if(mnsl_analysis_MNSLAnalyser.isNode(pNode)) {
		...
		while(_g < body.length) {
			...
			case 0:
				...
				if(inFunction != null && name == inFunction.name) {
					...
					this.checkForRecursion(body1,new mnsl_analysis_MNSLAnalyserFunction(name,args,returnType,null,null,true,null,null,null,null,null,null));
				}
				break;
			case 1:
				var name1 = node.name;
	...
	,run: function() {
		...
		var existingFuncs = [];
		var _g = 0;
		var _g1 = this._genericFuncs;
		while(_g < _g1.length) {
			var f = _g1[_g];
			++_g;
			var name = "" + f.name + (f.args.length > 0 ? "_T" : "");
			var _this = f.args;
			...
			while(_g2 < _g3) {
				var i = _g2++;
				result[i] = _this[i].type;
			}
			var name1 = name + result.join("_T") + "_RTT" + Std.string(f.ret);
			if(existingFuncs.indexOf(name1) != -1) {
				var _g4 = [];
				var _g5 = 0;
				var _g6 = this._toInsert;
				while(_g5 < _g6.length) {
					var v = _g6[_g5];
					++_g5;
					if(v.node != f.declNode) {
						_g4.push(v);
					}
				}
				this._toInsert = _g4;
		...
		var _g = 0;
		var _g1 = this._toInsert;
		while(_g < _g1.length) {
			var ins = _g1[_g];
			++_g;
			res.splice(ins.at,0,ins.node);
		}
		...
		var mainFunc = null;
		var _g = 0;
		var _g1 = this._globalCtx.functions;
		while(_g < _g1.length) {
			var f = _g1[_g];
			++_g;
			if(f.name == "main") {
		...
		if(mainFunc == null) {
			this._context.emitError(mnsl_MNSLError.AnalyserMissingMainFunction);
		} else if(!mainFunc.returnType.equals(new mnsl_analysis_MNSLType("Void"))) {
			this._context.emitError(mnsl_MNSLError.AnalyserInvalidReturnType(mainFunc,new mnsl_analysis_MNSLType("Void"),mainFunc.returnType));
			this._context.emitError(mnsl_MNSLError.AnalyserMissingMainFunction);
...
mnsl_analysis_MNSLAnalyserContext.__name__ = "mnsl.analysis.MNSLAnalyserContext";
...
var mnsl_analysis_MNSLAnalyserFunction = function(name,args,returnType,internal,scope,hasImplementation,remap,usages,node,atIdx,isTemplate,isInlined) {
...
mnsl_analysis_MNSLAnalyserFunction.__name__ = "mnsl.analysis.MNSLAnalyserFunction";
...
var mnsl_analysis_MNSLAnalyserFunctionUsage = function(varyingArgTypes,varyingRetType,callNode) {
	this.callNode = null;
	this.varyingRetType = null;
	this.varyingArgTypes = [];
	if(varyingArgTypes != null) {
		this.varyingArgTypes = varyingArgTypes;
	}
	if(varyingRetType != null) {
		this.varyingRetType = varyingRetType;
	}
	if(callNode != null) {
		this.callNode = callNode;
	}
};
mnsl_analysis_MNSLAnalyserFunctionUsage.__name__ = "mnsl.analysis.MNSLAnalyserFunctionUsage";
mnsl_analysis_MNSLAnalyserFunctionUsage.prototype = {
	toString: function() {
		return "MNSLAnalyserFunctionUsage(" + this.varyingArgTypes.toString() + ", " + (this.varyingRetType != null ? this.varyingRetType.toString() : "null") + ")";
	}
	,__class__: mnsl_analysis_MNSLAnalyserFunctionUsage
};
...
mnsl_analysis_MNSLAnalyserVariable.__name__ = "mnsl.analysis.MNSLAnalyserVariable";
...
var mnsl_analysis_MNSLConstraint = function(type,ofNode,mustBe,_optional,_isBinaryOp,_isLeftSide,_isRightSide,_operationOperator,_mustBeOfNode,_castable) {
	...
	if(_isLeftSide != null) {
		this._isLeftSide = _isLeftSide;
	}
	if(_isRightSide != null) {
		this._isRightSide = _isRightSide;
	}
...
mnsl_analysis_MNSLFuncArg.__name__ = "mnsl.analysis.MNSLFuncArg";
...
mnsl_analysis_MNSLReplaceCmd.__name__ = "mnsl.analysis.MNSLReplaceCmd";
...
mnsl_analysis_MNSLSolver.__name__ = "mnsl.analysis.MNSLSolver";
	...
	,tryCast: function(c) {
		...
		if(tmp && c._isBinaryOp) {
			...
			if(tmp != tmp1) {
				...
				this.addReplacement(new mnsl_analysis_MNSLReplaceCmd(c1,mnsl_parser_MNSLNode.VectorConversion(c.ofNode,tmp,tmp1)));
			}
			return true;
		}
		var tmp;
		...
		if(tmp && c._isBinaryOp) {
			...
			this.addReplacement(new mnsl_analysis_MNSLReplaceCmd(_g,mnsl_parser_MNSLNode.ImplicitTypeCast(c1,new mnsl_analysis_MNSLType("Vec" + type,false,[],false))));
			return true;
		}
		return false;
	}
...
var mnsl_analysis_MNSLType = function(t,temp,limits,userDefined) {
	if(temp == null) {
		temp = false;
	}
	...
	this._userDefined = userDefined != null && userDefined;
	this.setTypeStrUnsafe(t);
};
mnsl_analysis_MNSLType.__name__ = "mnsl.analysis.MNSLType";
mnsl_analysis_MNSLType.CreateTemplate = function(T,limits,userDefined) {
	if(userDefined == null) {
		userDefined = false;
	}
	return new mnsl_analysis_MNSLType("Template<" + T + ">",true,limits,userDefined);
};
mnsl_analysis_MNSLType.CreateArray = function(T,size,userDefined) {
	if(userDefined == null) {
		userDefined = false;
	}
	return new mnsl_analysis_MNSLType("Array<" + T + ", " + size + ">",false,[],userDefined);
};
mnsl_analysis_MNSLType.fromString = function(type,userDefined) {
	if(userDefined == null) {
		userDefined = false;
	}
	return new mnsl_analysis_MNSLType(type,false,[],userDefined);
};
...
mnsl_analysis_MNSLType.prototype = {
	...
	,setUserDefined: function(userDefined) {
	...
	,setTypeStrUnsafe: function(type) {
		if(StringTools.startsWith(type,"Array<") && StringTools.endsWith(type,">")) {
			...
			if(parts.length > 0) {
				this._arrayBaseType = new mnsl_analysis_MNSLType(parts[0],false,[],false);
			}
			if(parts.length > 1) {
	...
	,isDefined: function() {
		return this._type != "Unknown" && !this._tempType;
	}
	,isUnknown: function() {
	...
	,isNumerical: function() {
		return this._type == "Float" || this._type == "Int";
	}
	,isInt: function() {
	...
	,isTemplate: function() {
		return StringTools.startsWith(this._type,"Template<") && StringTools.endsWith(this._type,">");
	}
	...
	,isVector: function() {
		return this._type == "Vec" + 2 || this._type == "Vec" + 3 || this._type == "Vec" + 4;
	}
	...
	,isMatrix: function() {
		return this._type == "Mat" + 2 || this._type == "Mat" + 3 || this._type == "Mat" + 4;
	}
	,isBoolean: function() {
		return this._type == "Bool";
	}
...
mnsl_glsl_MNSLGLSLConfig.__name__ = "mnsl.glsl.MNSLGLSLConfig";
...
mnsl_glsl_MNSLGLSLPrinter.__name__ = "mnsl.glsl.MNSLGLSLPrinter";
...
mnsl_glsl_MNSLGLSLPrinter.prototype = $extend(mnsl_MNSLPrinter.prototype,{
	...
	,printNode: function(node) {
		...
		case 2:
			...
			var type = node.type;
			var info = node.info;
			var nodeIsVoid = node1 == null || node1._hx_index == 21;
		...
		case 17:
			...
			var type = node.type;
			var info = node.info;
			if(on._hx_index == 5 && on.name == "output") {
			...
			if(on._hx_index == 5 && on.name == "input") {
			...
			if(on._hx_index == 5 && on.name == "uniform") {
				var _g = 0;
				var _g1 = this._context.getShaderData();
				while(_g < _g1.length) {
					var data = _g1[_g];
...
mnsl_optimiser_MNSLOptimiser.__name__ = "mnsl.optimiser.MNSLOptimiser";
...
mnsl_optimiser_MNSLOptimiserPlugin.__name__ = "mnsl.optimiser.MNSLOptimiserPlugin";
...
mnsl_optimiser_impl_MNSLOptimiseScalarVectorInit.__name__ = "mnsl.optimiser.impl.MNSLOptimiseScalarVectorInit";
...
mnsl_optimiser_impl_MNSLOptimiseSwizzleAccess.__name__ = "mnsl.optimiser.impl.MNSLOptimiseSwizzleAccess";
...
mnsl_optimiser_impl_MNSLOptimiseSwizzleAssign.__name__ = "mnsl.optimiser.impl.MNSLOptimiseSwizzleAssign";
...
mnsl_optimiser_impl_MNSLOptimiseSwizzleAssign.prototype = $extend(mnsl_optimiser_MNSLOptimiserPlugin.prototype,{
	onRun: function(node,params,optimizer) {
		...
		if(!this.allMatchFunction(params[0],function(node) {
			if(node._hx_index == 4) {
				var _gname = node.name;
				if(_gname._hx_index == 17) {
					var on = _gname.on;
					var field = _gname.field;
					var type = _gname.type;
					var stuctInfo = _gname.info;
					var value = node.value;
					var info = node.info;
					if(optimInfo == null) {
						optimInfo = info;
...
var mnsl_parser_MNSLNode = $hxEnums["mnsl.parser.MNSLNode"] = { __ename__:"mnsl.parser.MNSLNode",__constructs__:null
	,FunctionDecl: ($_=function(name,returnType,$arguments,body,inlined,info) { return {_hx_index:0,name:name,returnType:returnType,$arguments:$arguments,body:body,inlined:inlined,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.name,this.returnType,this.$arguments,this.body,this.inlined,this.info];}}; },$_._hx_name="FunctionDecl",$_)
	,FunctionCall: ($_=function(name,args,returnType,info) { return {_hx_index:1,name:name,args:args,returnType:returnType,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.name,this.args,this.returnType,this.info];}}; },$_._hx_name="FunctionCall",$_)
	,Return: ($_=function(value,type,info) { return {_hx_index:2,value:value,type:type,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.value,this.type,this.info];}}; },$_._hx_name="Return",$_)
	,VariableDecl: ($_=function(name,type,value,info) { return {_hx_index:3,name:name,type:type,value:value,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.name,this.type,this.value,this.info];}}; },$_._hx_name="VariableDecl",$_)
	,VariableAssign: ($_=function(name,value,info) { return {_hx_index:4,name:name,value:value,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.name,this.value,this.info];}}; },$_._hx_name="VariableAssign",$_)
	,Identifier: ($_=function(name,type,info) { return {_hx_index:5,name:name,type:type,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.name,this.type,this.info];}}; },$_._hx_name="Identifier",$_)
	,IfStatement: ($_=function(condition,body,info) { return {_hx_index:6,condition:condition,body:body,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.condition,this.body,this.info];}}; },$_._hx_name="IfStatement",$_)
	,ElseIfStatement: ($_=function(condition,body,info) { return {_hx_index:7,condition:condition,body:body,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.condition,this.body,this.info];}}; },$_._hx_name="ElseIfStatement",$_)
	,ElseStatement: ($_=function(body,info) { return {_hx_index:8,body:body,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.body,this.info];}}; },$_._hx_name="ElseStatement",$_)
	,BinaryOp: ($_=function(left,op,right,type,info) { return {_hx_index:9,left:left,op:op,right:right,type:type,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.left,this.op,this.right,this.type,this.info];}}; },$_._hx_name="BinaryOp",$_)
	,UnaryOp: ($_=function(op,right,info) { return {_hx_index:10,op:op,right:right,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.op,this.right,this.info];}}; },$_._hx_name="UnaryOp",$_)
	,WhileLoop: ($_=function(condition,body,info) { return {_hx_index:11,condition:condition,body:body,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.condition,this.body,this.info];}}; },$_._hx_name="WhileLoop",$_)
	,ForLoop: ($_=function(init,condition,increment,body,info) { return {_hx_index:12,init:init,condition:condition,increment:increment,body:body,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.init,this.condition,this.increment,this.body,this.info];}}; },$_._hx_name="ForLoop",$_)
	,Break: ($_=function(info) { return {_hx_index:13,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Break",$_)
	,Continue: ($_=function(info) { return {_hx_index:14,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Continue",$_)
	,SubExpression: ($_=function(node,info) { return {_hx_index:15,node:node,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.node,this.info];}}; },$_._hx_name="SubExpression",$_)
	,Block: ($_=function(body,info) { return {_hx_index:16,body:body,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.body,this.info];}}; },$_._hx_name="Block",$_)
	,StructAccess: ($_=function(on,field,type,info) { return {_hx_index:17,on:on,field:field,type:type,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.on,this.field,this.type,this.info];}}; },$_._hx_name="StructAccess",$_)
	,ArrayAccess: ($_=function(on,index,info) { return {_hx_index:18,on:on,index:index,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.on,this.index,this.info];}}; },$_._hx_name="ArrayAccess",$_)
	,TypeCast: ($_=function(on,from,to) { return {_hx_index:19,on:on,from:from,to:to,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.on,this.from,this.to];}}; },$_._hx_name="TypeCast",$_)
	,ImplicitTypeCast: ($_=function(on,to) { return {_hx_index:20,on:on,to:to,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.on,this.to];}}; },$_._hx_name="ImplicitTypeCast",$_)
	,VoidNode: ($_=function(info) { return {_hx_index:21,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="VoidNode",$_)
	,TypeWrapper: ($_=function(type) { return {_hx_index:22,type:type,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.type];}}; },$_._hx_name="TypeWrapper",$_)
	,VectorCreation: ($_=function(components,nodes,info) { return {_hx_index:23,components:components,nodes:nodes,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.components,this.nodes,this.info];}}; },$_._hx_name="VectorCreation",$_)
	,VectorConversion: ($_=function(on,fromComponents,toComponents) { return {_hx_index:24,on:on,fromComponents:fromComponents,toComponents:toComponents,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.on,this.fromComponents,this.toComponents];}}; },$_._hx_name="VectorConversion",$_)
	,MatrixCreation: ($_=function(size,nodes,info) { return {_hx_index:25,size:size,nodes:nodes,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.size,this.nodes,this.info];}}; },$_._hx_name="MatrixCreation",$_)
	,IntegerLiteralNode: ($_=function(value,info) { return {_hx_index:26,value:value,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.value,this.info];}}; },$_._hx_name="IntegerLiteralNode",$_)
	,FloatLiteralNode: ($_=function(value,info) { return {_hx_index:27,value:value,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.value,this.info];}}; },$_._hx_name="FloatLiteralNode",$_)
	,StringLiteralNode: ($_=function(value,info) { return {_hx_index:28,value:value,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.value,this.info];}}; },$_._hx_name="StringLiteralNode",$_)
	,BooleanLiteralNode: ($_=function(value,info) { return {_hx_index:29,value:value,info:info,__enum__:"mnsl.parser.MNSLNode",toString:$estr,__params__:function(){ return [this.value,this.info];}}; },$_._hx_name="BooleanLiteralNode",$_)
};
...
mnsl_parser_MNSLNodeInfo.__name__ = "mnsl.parser.MNSLNodeInfo";
...
mnsl_parser_MNSLNodeInfo.fromTokenInfos = function(tokenInfos) {
	...
	var last = tokenInfos[0];
	var last1 = last != null ? last : new mnsl_tokenizer_MNSLTokenInfo(0,0,null,0);
	var _g = 0;
	while(_g < tokenInfos.length) {
		...
		if(tokenInfo.line > last1.line || tokenInfo.line == last1.line && tokenInfo.column + tokenInfo.length > last1.column + last1.length) {
			last1 = tokenInfo;
		}
	}
	return new mnsl_parser_MNSLNodeInfo(first.line,first.column,last1.line,last1.column + last1.length);
};
...
var mnsl_parser_MNSLParser = function(context,tokens,localNodeDefs) {
	...
	this.keywords = ["func","return","var","if","else","while","for","break","continue","inline"];
	this.tokens = tokens;
	this.currentIndex = 0;
	this.ast = [];
	this.context = context;
	this.dataList = [];
	var tmp = localNodeDefs;
...
mnsl_parser_MNSLParser.prototype = {
	...
	,_runInternal: function() {
		while(this.currentIndex < this.tokens.length) {
			...
			case 21:
				...
				break;
			case 24:
				this.parseArrowChain(token);
				break;
			default:
				if(this.isOperator(token)) {
					if(this.peekCurrentToken(0)._hx_index == 21) {
	...
	,parseShaderDataMeta: function(block,kind) {
		...
		if(colonToken == null || colonToken._hx_index != 23) {
		...
		if(bracketOpenToken != null) {
			...
			if(bracketCloseToken == null || bracketCloseToken._hx_index != 9) {
		...
		if(arraySizeInt == -1) {
			...
			shData = new mnsl_analysis_MNSLType(type,false,[],userDefined);
		} else {
			shData = mnsl_analysis_MNSLType.CreateArray(type,arraySizeInt,true);
		}
		var shData1 = new mnsl_parser_MNSLShaderData(kind,shData,name,arraySizeInt);
		this.dataList.push(shData1);
	}
	,parseDefineMeta: function(block) {
		...
		if(commaToken == null || commaToken._hx_index != 12) {
	...
	,parseElseStmt: function(value,info) {
		...
		if(last == null || last._hx_index != 6 && last._hx_index != 7) {
	...
	,parseOperatorAssignment: function(token) {
		...
		var rightTokens = [];
		while(this.currentIndex < this.tokens.length && this.tokens[this.currentIndex]._hx_index != 16) {
	...
	,parseFunctionCall: function(value,info) {
		...
		while(_g < argsTokens.length) {
			...
			++_g;
			var c = new mnsl_parser_MNSLParser(this.context,argTokens,this.localNodeDefs);
	...
	,parseFunctionDecl: function(value,info) {
		...
		var genericNames = [];
		if(this.peekCurrentTokenType(0) == "Less") {
			var genericsBlock = this.getBlock(mnsl_tokenizer_MNSLToken.Less(null),mnsl_tokenizer_MNSLToken.Greater(null));
			var genericsTokens = this.splitBlock(genericsBlock,mnsl_tokenizer_MNSLToken.Comma(null));
			var _g = 0;
			while(_g < genericsTokens.length) {
				var t = genericsTokens[_g];
				++_g;
				if(t.length == 0) {
					this.context.emitError(mnsl_MNSLError.ParserUnexpectedToken(genericsBlock[0],info));
					continue;
				}
				if(t.length > 1) {
					this.context.emitError(mnsl_MNSLError.ParserUnexpectedToken(t[1],info));
					continue;
				}
				var token = t[0];
				var genericName = this.getTokenValue(token);
		...
		while(_g < paramsTokens.length) {
			...
			if(genericNames.indexOf(type) != -1) {
				paramType.setType(mnsl_analysis_MNSLType.CreateTemplate(type,[]));
		...
		if(this.peekCurrentTokenType(0) == "Colon") {
			...
			if(genericNames.indexOf(type) != -1) {
				returnType.setType(mnsl_analysis_MNSLType.CreateTemplate(type,[]));
		...
		var body = new mnsl_parser_MNSLParser(this.context,bodyBlock,this.localNodeDefs)._runInternal();
		this.append(mnsl_parser_MNSLNode.FunctionDecl(name,returnType,params,body,this.doInline > 0,mnsl_parser_MNSLNodeInfo.fromTokenInfos([info,this.getTokenInfo(bodyBlock[bodyBlock.length - 1])])));
	}
	...
	,parseOperator: function(token) {
		...
		var subExprDepth = 0;
		while(this.currentIndex < this.tokens.length) {
			if(this.tokens[this.currentIndex]._hx_index == 6) {
				++subExprDepth;
			}
			...
			if(this.tokens[this.currentIndex]._hx_index == 7) {
				--subExprDepth;
			}
			rightTokens.push(this.tokens[this.currentIndex]);
			this.currentIndex++;
...
mnsl_parser_MNSLParserResults.__name__ = "mnsl.parser.MNSLParserResults";
...
mnsl_parser_MNSLShaderData.__name__ = "mnsl.parser.MNSLShaderData";
mnsl_parser_MNSLShaderData.prototype = {
	__class__: mnsl_parser_MNSLShaderData
};
var mnsl_parser_MNSLShaderDataKind = $hxEnums["mnsl.parser.MNSLShaderDataKind"] = { __ename__:"mnsl.parser.MNSLShaderDataKind",__constructs__:null
...
mnsl_spirv_MNSLSPIRVConfig.__name__ = "mnsl.spirv.MNSLSPIRVConfig";
...
mnsl_spirv_MNSLSPIRVPrinter.__name__ = "mnsl.spirv.MNSLSPIRVPrinter";
...
mnsl_spirv_MNSLSPIRVPrinter.prototype = $extend(mnsl_MNSLPrinter.prototype,{
	...
	,getType: function(type) {
		if(type._type == "Unknown") {
			type.setType(new mnsl_analysis_MNSLType("Void"));
		}
		...
		if(type._type == "Mat" + 2 || type._type == "Mat" + 3 || type._type == "Mat" + 4) {
			...
			this._typeInit.push({ id : id, op : 24, oper : [id,this.getType(new mnsl_analysis_MNSLType("Vec" + w,false,[],false)),h]});
			return id;
		}
		if(type._type == "Vec" + 2 || type._type == "Vec" + 3 || type._type == "Vec" + 4) {
		...
		case "Int":
			...
			break;
		case "Sampler":
			var sampledId = this.assignId();
			this._typeInit.push({ id : sampledId, op : 25, oper : [sampledId,this.getType(new mnsl_analysis_MNSLType("Float")),1,0,0,0,1,0]});
			this._typeInit.push({ id : id, op : 27, oper : [id,sampledId]});
	...
	,getVar: function(on,scope,inBody,at,requirePtr) {
		if(requirePtr == null) {
			requirePtr = false;
		}
		var _gthis = this;
		...
		iterNode = function(node) {
			...
			case 23:
				...
				var values = node.nodes;
				var info = node.info;
				stack.push({ name : "vec" + comp + "(...)", type : new mnsl_analysis_MNSLType("Vec" + comp,false,[],false), node : node, arrayIndex : null});
				break;
			default:
		...
		var enter = function(name,type,node,isLast,arrayIndex) {
			...
			if(name == "__mnsl_eval_tmp") {
				var funcRet = _gthis.emitNode(node,scope,inBody,at);
				currRetId = funcRet;
				currIsParam = true;
				lastType = type;
				return;
			...
			if(name == "__mnsl_array_access") {
				var indexId = _gthis.emitNode(arrayIndex,scope,inBody,at);
	...
	,emitBody: function(body,scope,branchTo) {
		if(body == null) {
			body = [];
		}
		var bodyHasReturned = false;
		var _g = 0;
		var _g1 = body.length;
		while(_g < _g1) {
			var nodeIdx = _g++;
			...
			case 2:
				...
				break;
			case 6:
				this.emitIfStatement(body,nodeIdx,scope,branchTo);
				return;
			case 11:
				var whileCond = node.condition;
				var whileBody = node.body;
				var whileInfo = node.info;
				this.emitWhileLoop(whileCond,whileBody,whileInfo,scope,body,nodeIdx,branchTo);
				return;
			case 12:
				var forInit = node.init;
				var forCond = node.condition;
				var forInc = node.increment;
				var forBody = node.body;
		...
		if(branchTo != null && !bodyHasReturned) {
			this.emitInstruction(249,[branchTo]);
		}
	}
	,emitNode: function(node,scope,inBody,at) {
		switch(node._hx_index) {
		case 0:
			var name = node.name;
			var returnType = node.returnType;
			...
			var inlined = node.inlined;
			var info = node.info;
			return this.emitFunctionDecl(name,returnType,$arguments,body,inlined,info,scope,inBody,at);
		case 1:
			var name = node.name;
			var args = node.args;
			var returnType = node.returnType;
			var info = node.info;
			return this.emitFunctionCall(name,args,returnType,info,scope,inBody,at);
		case 2:
			var value = node.value;
			var type = node.type;
			var info = node.info;
			return this.emitReturn(value,type,info,scope,inBody,at);
		case 3:
			var name = node.name;
			var type = node.type;
			var value = node.value;
			var info = node.info;
			return this.emitVariableDecl(name,type,value,info,scope,inBody,at);
		case 4:
			var name = node.name;
			var value = node.value;
			var info = node.info;
			return this.emitVariableAssign(name,value,info,scope,inBody,at);
		case 5:
			var name = node.name;
			var type = node.type;
			var info = node.info;
			return this.emitIdentifier(name,type,info,scope,inBody,at);
		case 9:
			var left = node.left;
			var op = node.op;
			var right = node.right;
			var type = node.type;
			var info = node.info;
			return this.emitBinaryOp(left,op,right,type,info,scope,inBody,at);
		case 10:
			var op = node.op;
			var right = node.right;
			var info = node.info;
		...
		case 15:
			var node1 = node.node;
			var info = node.info;
			return this.emitNode(node1,scope,inBody,at);
		case 16:
			var body = node.body;
			var info = node.info;
		...
		case 17:
			...
			var type = node.type;
			var info = node.info;
			return this.emitStructAccess(on,field,type,info,scope,inBody,at);
		case 18:
			var on = node.on;
			var index = node.index;
			var info = node.info;
			return this.emitArrayAccess(on,index,mnsl_analysis_MNSLAnalyser.getType(node),info,scope,inBody,at);
		case 19:
			var on = node.on;
			var from = node.from;
			var to = node.to;
	...
	,emitMatrixCreation: function(size,nodes,info,scope,inBody,at) {
		...
		var id = this.assignId();
		var type = new mnsl_analysis_MNSLType("Mat" + size,false,[],false);
		var matrixType = this.getType(type);
		var vectorType = this.getType(new mnsl_analysis_MNSLType("Vec" + size,false,[],false));
		var columnVectors = [];
		var _g = 0;
		var _g1 = size;
		while(_g < _g1) {
	...
	,emitWhileLoop: function(cond,body,info,scope,inBody,at,branchTo) {
		...
		var loopLabel = this.assignId();
		var mergeLabel = this.assignId();
		var enterLabel = this.assignId();
		var branchToEnter = this.assignId();
		var whileAfter = inBody.slice(at + 1);
		this.emitInstruction(249,[enterLabel]);
		this.emitInstruction(248,[enterLabel]);
		this.emitInstruction(246,[mergeLabel,branchToEnter,0]);
		this.emitInstruction(249,[headerLabel]);
		...
		this.emitBody(whileAfter,scope,branchTo);
		if(whileAfter.length == 0 && branchTo == null) {
			this.emitInstruction(255,[]);
		}
		return 0;
	}
	,emitForLoop: function(init,cond,inc,body,info,scope,inBody,at,branchTo) {
		var headerLabel = this.assignId();
		var loopLabel = this.assignId();
		var mergeLabel = this.assignId();
		var enterLabel = this.assignId();
		var branchToEnter = this.assignId();
		var iterLabel = this.assignId();
		var forAfter = inBody.slice(at + 1);
		this.emitNode(init,scope,inBody,at);
		this.emitInstruction(249,[enterLabel]);
		this.emitInstruction(248,[enterLabel]);
		this.emitInstruction(246,[mergeLabel,branchToEnter,0]);
		this.emitInstruction(249,[headerLabel]);
		...
		this.emitInstruction(249,[enterLabel]);
		this.emitInstruction(248,[mergeLabel]);
		this.emitBody(forAfter,scope,branchTo);
		if(forAfter.length == 0 && branchTo == null) {
			this.emitInstruction(255,[]);
		}
		return 0;
	}
	,emitIfStatement: function(inBody,at,scope,branchTo) {
		var condChainIdx = at;
		var condChainStatements = [];
		var condChainElse = null;
		_hx_loop1: while(condChainIdx < inBody.length) {
			var condChainNode = inBody[condChainIdx];
			switch(condChainNode._hx_index) {
			case 6:
				var chainCond = condChainNode.condition;
				var chainBody = condChainNode.body;
				var chainInfo = condChainNode.info;
				...
				break;
			case 7:
				var chainCond1 = condChainNode.condition;
				var chainBody1 = condChainNode.body;
				var chainInfo1 = condChainNode.info;
				condChainStatements.push({ cond : chainCond1, body : chainBody1, info : chainInfo1});
				break;
			case 8:
				var chainBody2 = condChainNode.body;
				var chainInfo2 = condChainNode.info;
				condChainElse = chainBody2;
				break _hx_loop1;
			default:
				break _hx_loop1;
			}
		...
		if(condChainStatements.length > 1) {
			var newElseBody = [];
			var _g = 1;
			var _g1 = condChainStatements.length;
			while(_g < _g1) {
				var i = _g++;
				var chain = condChainStatements[i];
				newElseBody.push(i == 1 ? mnsl_parser_MNSLNode.IfStatement(chain.cond,chain.body,chain.info) : mnsl_parser_MNSLNode.ElseIfStatement(chain.cond,chain.body,chain.info));
			}
			var body = condChainElse;
			newElseBody.push(mnsl_parser_MNSLNode.ElseStatement(body != null ? body : [],condInfo.info));
		...
		if(condChainElse != null) {
			...
			var body = condChainElse;
			this.emitBody(body != null ? body : [],scope,mergeLabel);
		}
		this.emitInstruction(248,[trueLabel]);
		this.emitBody(condInfo.body,scope,mergeLabel);
		this.emitInstruction(248,[mergeLabel]);
		this.emitBody(condAfter,scope,branchTo);
		if(condAfter.length == 0 && branchTo == null) {
			this.emitInstruction(255,[]);
		}
		return 0;
	}
	,emitStructAccess: function(on,field,type,info,scope,inBody,at) {
		var varDef = this.getVar(mnsl_parser_MNSLNode.StructAccess(on,field,type,info),scope,inBody,at);
		if(varDef.isParam) {
			return varDef.id;
		}
	...
	,emitArrayAccess: function(on,index,type,info,scope,inBody,at) {
		var varDef = this.getVar(mnsl_parser_MNSLNode.ArrayAccess(on,index,info),scope,inBody,at);
		if(varDef.isParam) {
			return varDef.id;
		}
		var typeId = this.getType(type);
		var resultId = this.assignId();
		var indexId = this.emitNode(index,scope,inBody,at);
		this.emitInstruction(61,[typeId,resultId,varDef.id]);
		this.emitInstruction(65,[this.getPtr(typeId,7),resultId,resultId,indexId]);
		return resultId;
	}
	,emitIdentifier: function(name,type,info,scope,inBody,at) {
		var varDef = this.getVar(mnsl_parser_MNSLNode.Identifier(name,type,info),scope,inBody,at);
		if(varDef.isParam) {
			return varDef.id;
		}
		var typeId = this.getType(type);
	...
	,emitVariableAssign: function(on,value,info,scope,inBody,at) {
		var varDef = this.getVar(on,scope,inBody,at,true);
		var valueId = this.emitNode(value,scope,inBody,at);
		if(scope.swizzlePointers.h.hasOwnProperty(varDef.id)) {
			return this.emitSwizzleStore(varDef.id,valueId,scope,inBody,at);
		}
		this.emitInstruction(62,[varDef.id,valueId]);
		return varDef.id;
	}
	,emitSwizzleStore: function(swizzleId,valueId,scope,inBody,at) {
	...
	,emitVariableDecl: function(name,type,value,info,scope,inBody,at) {
	...
	,emitVectorConversion: function(on,fromComp,toComp,scope,inBody,at) {
		var onId = this.emitNode(on,scope,inBody,at);
		var fromType = new mnsl_analysis_MNSLType("Vec" + fromComp,false,[],false);
		var toType = new mnsl_analysis_MNSLType("Vec" + toComp,false,[],false);
		if(fromComp == toComp) {
			return onId;
		} else if(fromComp < toComp) {
			var resultId = this.assignId();
	...
	,emitVectorCreation: function(comp,nodes,info,scope,inBody,at) {
		...
		var type = new mnsl_analysis_MNSLType("Vec" + comp,false,[],false);
		var typeId = this.getType(type);
		var resId = this.assignId();
		if(nodes.length == 1) {
			var scalarId = this.emitTypeCast(nodes[0],mnsl_analysis_MNSLAnalyser.getType(nodes[0]),new mnsl_analysis_MNSLType("Float"),scope,inBody,at);
			var _g = [];
			var _g1 = 0;
			var _g2 = comp;
			while(_g1 < _g2) {
		...
		while(_g1 < nodes.length) {
			var n = nodes[_g1];
			++_g1;
			_g.push(this.emitTypeCast(n,mnsl_analysis_MNSLAnalyser.getType(n),new mnsl_analysis_MNSLType("Float"),scope,inBody,at));
		}
		this.emitInstruction(80,[typeId,resId].concat(_g));
		return resId;
	}
	,emitTypeCast: function(on,from,to,scope,inBody,at) {
		var onId = this.emitNode(on,scope,inBody,at);
		if(from.equals(to)) {
			return onId;
		}
	...
	,emitUnaryOp: function(op,right,info,scope,inBody,at) {
	...
	,emitFunctionDecl: function(name,returnType,$arguments,body,inlined,info,scope,inBody,at) {
		scope = scope.copy();
		var _g = [];
		var _g1 = 0;
	...
	,emitBuiltinFunctionCall: function(name,args,returnType,info,glslMapping,scope,inBody,at) {
		var _g = [];
		var _g1 = 0;
		while(_g1 < args.length) {
			var arg = args[_g1];
			++_g1;
			_g.push(this.emitNode(arg,scope,inBody,at));
		}
		var argIds = _g;
	...
	,emitFunctionCall: function(name,args,returnType,info,scope,inBody,at) {
		var _g = 0;
		...
		while(_g < _g1.length) {
			...
			++_g;
			if(func.name == name) {
				return this.emitBuiltinFunctionCall(name,args,returnType,info,func.mapping,scope,inBody,at);
			}
		}
	...
	,emitReturn: function(value,type,info,scope,inBody,at) {
		if(value._hx_index == 21) {
			...
			this.emitInstruction(254,[this.emitNode(value,scope,inBody,at)]);
		}
		return 0;
	}
	,getBytes: function() {
...
mnsl_spirv_MNSLSPIRVScope.__name__ = "mnsl.spirv.MNSLSPIRVScope";
...
var mnsl_tokenizer_MNSLToken = $hxEnums["mnsl.tokenizer.MNSLToken"] = { __ename__:"mnsl.tokenizer.MNSLToken",__constructs__:null
	,None: {_hx_name:"None",_hx_index:0,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr}
	,At: ($_=function(info) { return {_hx_index:1,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="At",$_)
	,Identifier: ($_=function(value,info) { return {_hx_index:2,value:value,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.value,this.info];}}; },$_._hx_name="Identifier",$_)
	,IntegerLiteral: ($_=function(value,info) { return {_hx_index:3,value:value,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.value,this.info];}}; },$_._hx_name="IntegerLiteral",$_)
	,FloatLiteral: ($_=function(value,info) { return {_hx_index:4,value:value,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.value,this.info];}}; },$_._hx_name="FloatLiteral",$_)
	,StringLiteral: ($_=function(value,info) { return {_hx_index:5,value:value,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.value,this.info];}}; },$_._hx_name="StringLiteral",$_)
	,LeftParen: ($_=function(info) { return {_hx_index:6,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="LeftParen",$_)
	,RightParen: ($_=function(info) { return {_hx_index:7,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="RightParen",$_)
	,LeftBracket: ($_=function(info) { return {_hx_index:8,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="LeftBracket",$_)
	,RightBracket: ($_=function(info) { return {_hx_index:9,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="RightBracket",$_)
	,LeftBrace: ($_=function(info) { return {_hx_index:10,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="LeftBrace",$_)
	,RightBrace: ($_=function(info) { return {_hx_index:11,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="RightBrace",$_)
	,Comma: ($_=function(info) { return {_hx_index:12,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Comma",$_)
	,Dot: ($_=function(info) { return {_hx_index:13,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Dot",$_)
	,Minus: ($_=function(info) { return {_hx_index:14,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Minus",$_)
	,Plus: ($_=function(info) { return {_hx_index:15,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Plus",$_)
	,Semicolon: ($_=function(info) { return {_hx_index:16,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Semicolon",$_)
	,Slash: ($_=function(info) { return {_hx_index:17,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Slash",$_)
	,Star: ($_=function(info) { return {_hx_index:18,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Star",$_)
	,Percent: ($_=function(info) { return {_hx_index:19,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Percent",$_)
	,Question: ($_=function(info) { return {_hx_index:20,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Question",$_)
	,Assign: ($_=function(info) { return {_hx_index:21,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Assign",$_)
	,Equal: ($_=function(info) { return {_hx_index:22,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Equal",$_)
	,Colon: ($_=function(info) { return {_hx_index:23,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Colon",$_)
	,Arrow: ($_=function(info) { return {_hx_index:24,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Arrow",$_)
	,Spread: ($_=function(info) { return {_hx_index:25,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Spread",$_)
	,And: ($_=function(info) { return {_hx_index:26,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="And",$_)
	,Or: ($_=function(info) { return {_hx_index:27,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Or",$_)
	,Less: ($_=function(info) { return {_hx_index:28,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Less",$_)
	,Greater: ($_=function(info) { return {_hx_index:29,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Greater",$_)
	,LessEqual: ($_=function(info) { return {_hx_index:30,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="LessEqual",$_)
	,GreaterEqual: ($_=function(info) { return {_hx_index:31,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="GreaterEqual",$_)
	,NotEqual: ($_=function(info) { return {_hx_index:32,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="NotEqual",$_)
	,Not: ($_=function(info) { return {_hx_index:33,info:info,__enum__:"mnsl.tokenizer.MNSLToken",toString:$estr,__params__:function(){ return [this.info];}}; },$_._hx_name="Not",$_)
};
...
mnsl_tokenizer_MNSLTokenInfo.__name__ = "mnsl.tokenizer.MNSLTokenInfo";
...
mnsl_tokenizer_MNSLTokenizer.__name__ = "mnsl.tokenizer.MNSLTokenizer";
